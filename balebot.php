...
class BaleBot
{
    ...
    public function createUserId($sender_type,$sender_id,$sender_accessHash){
        return $this->create_chat_id($sender_type,$sender_id,$sender_accessHash);
    }
    ...
    public function createUserIdFromSender($sender){
        return $this->create_chat_id_from_peer($sender);
    }
     ...
     * @param string $sticker_accessHash file access has
     * @return string
     */
